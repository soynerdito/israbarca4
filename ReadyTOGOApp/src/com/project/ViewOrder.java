...
public class ViewOrder extends BaseActivity {
    ...
    protected Intent confirmit;
    protected ListView lv1;
    protected ArrayAdapter<String> adapter;
    protected TextView totalText;
    protected ArrayList<menulist1> items = new ArrayList<menulist1>();
    protected AlertDialog.Builder alert;
    protected String Build = null;
    protected int k, z, pri;
    protected Bundle g;
